...
class _$TaskEntityCopyWithImpl<$Res, $Val extends TaskEntity>
  ...
  @pragma('vm:prefer-inline')
  $TaskDueDateEntityCopyWith<$Res>? get dueDateEntity {
    if (_value.dueDateEntity == null) {
      return null;
    }

    return $TaskDueDateEntityCopyWith<$Res>(_value.dueDateEntity!, (value) {
      return _then(_value.copyWith(dueDateEntity: value) as $Val);
    });
  }
}
